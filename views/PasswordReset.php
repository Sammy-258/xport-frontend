                    ...
                    <div class="formbox w-100 p-lg-5 py-5">
                        ...
                        <?php
                            ...
                            if(isset($_SESSION["responses"])){
                                ...
                                if(isset($_SESSION["responses"]["reset_code"])){
                                    $reset_code = $_SESSION["responses"]["reset_code"];
                                }else{
                                    $reset_code = "";
                                }
                        ...
                        <div id="myModal" class="modal">
                            ...
                            <div class="modal-content">
                                ...
                                <form action="PasswordResetSecond" method="post">
                                    <div class="px-lg-5 px-4">
                                        <p class="text-center fw-bold mt-5 mt-md-0">Reset Password</p>
                                        <div class="row justify-content-center">
                                            <div class="col-12">
                                                <label for="email" class="pb-1 fw-bold">Enter The reset password code</label>
                                            </div>
                                            <div class="col-12">
                                                <input type="number" name="reset_code" class="w-100" required>
                                            </div>
                                            <p class="text-grey text-center mt-2"><?=$message?> <?=$reset_code?></p>
                        
                                        
                                            
                                            <button class="log fw-bold mt-4">Submit</button>

                                            <p class="text-center fw-bold mt-4">Return Back to <a href="Login">login</a></p>
